...
public class JwtUtils {
    ...
    public static String generateTokenExpireInMinutes(Object userInfo,
                                                      PrivateKey privateKey, int expire) {
//计算过期时间
        ...
        return Jwts.builder()
                ...
                .setId(new
                        String(Base64.getEncoder().encode(UUID.randomUUID().toString().getBytes())))
...
//计算过期时间
     ...
     * @return 用户信息
     */
    public static Object getInfoFromToken(String token, PublicKey publicKey,
                                          Class userType) {
//解析token
